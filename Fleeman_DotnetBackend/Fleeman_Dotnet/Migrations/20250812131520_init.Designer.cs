            ...
            modelBuilder.Entity("Fleeman_Dotnet.Models.add_on_master", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("add_on_id"));
            ...
            modelBuilder.Entity("Fleeman_Dotnet.Models.booking_detail_table", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("booking_detail_id"));
            ...
            modelBuilder.Entity("Fleeman_Dotnet.Models.car_type_master", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("cartype_id"));
            ...
            modelBuilder.Entity("Fleeman_Dotnet.Models.hub_master", b =>
                {
                    ...
                    b.HasIndex(new[] { "contact_number" }, "UKq4cka6kuf15mrgsvs05wj1e87")
                        .IsUnique()
                        .HasFilter("[contact_number] IS NOT NULL");
            ...
            modelBuilder.Entity("Fleeman_Dotnet.Models.invoice_detail_table", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("invdtl_id"));
